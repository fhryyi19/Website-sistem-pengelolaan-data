...
<body class="h-full bg-[#f5f5f7] flex items-center justify-center p-4 font-sans text-[#1d1d1f]">
    <div class="max-w-md w-full text-center space-y-6">
        <div class="w-16 h-16 bg-red-100 text-red-600 rounded-3xl mx-auto flex items-center justify-center font-bold text-xl">403</div>
        <h1 class="text-2xl font-bold tracking-tight">Akses Ditolak</h1>
        <p class="text-xs text-[#7a7a7a]">Anda tidak memiliki izin atau hak akses yang cukup untuk membuka halaman ini.</p>
